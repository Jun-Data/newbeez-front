...
> **마지막 업데이트: 2026-08-11 — 시스템 설계 확정(ARCHITECTURE 신설) · 인물 큐레이션 · 표기 통일**
> **현재 브랜치: `feat/quiz-intro` (커밋 없음, main과 동일 지점) · main = `144fc45`**
...
- 🔨 **S2 quiz-intro** ← **진행 중** (`feat/quiz-intro`, 미커밋): `/football/quiz` 인트로 + 히어로 이미지
...
- ⬜ **S5 quiz-store** — Zustand + `/football/quiz/play` 셸 + Q1
- ⬜ **S6 quiz-scale** — `<BipolarScale>` (Q2~Q9)
